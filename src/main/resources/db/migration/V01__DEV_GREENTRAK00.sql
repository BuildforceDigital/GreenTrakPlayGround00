...
CREATE TABLE DEV_GREENTRAK00.SIMPLEUUIDS (ID UUID, NAME VARCHAR(10), PRIMARY KEY (ID));

INSERT INTO DEV_GREENTRAK00.SIMPLEUUIDS VALUES ('04a47a98-5237-4cc8-b2fa-c629bd8f019e', 'AA');
INSERT INTO DEV_GREENTRAK00.SIMPLEUUIDS VALUES ('4e65220e-9332-442e-b0bc-d1b5b16c1db8', 'Ab');
INSERT INTO DEV_GREENTRAK00.SIMPLEUUIDS VALUES ('9dfa89d3-2387-455e-be80-0ed77c200fa3', 'Ac');
INSERT INTO DEV_GREENTRAK00.SIMPLEUUIDS VALUES ('a7de5d72-9e03-4341-9e7d-a348aaa8eac2', 'Ad');
INSERT INTO DEV_GREENTRAK00.SIMPLEUUIDS VALUES ('caa70247-ad7c-4b68-8949-edec7e879ae2', 'Ae');
INSERT INTO DEV_GREENTRAK00.SIMPLEUUIDS VALUES ('f2a3b1de-ee88-4b28-8572-9d6afc856116', 'Af');

CREATE TABLE DEV_GREENTRAK00.SIMPLEINTS (ID INTEGER, NAME VARCHAR(10), PRIMARY KEY (ID));
INSERT INTO DEV_GREENTRAK00.SIMPLEINTS VALUES (10, 'AA');
...
INSERT INTO DEV_GREENTRAK00.PROFILES VALUES ('04a47a9852374cc8b2fac629bd8f019e', 'Bd', 'Be', 'Csnr', 'TestActor05', 'M', 'Jf', 'lp', 'mp', 'nat', 'Jan',    'pe', '2020-05-01', 'us0', null, null);
INSERT INTO DEV_GREENTRAK00.PROFILES VALUES ('4e65220e9332442eb0bcd1b5b16c1db8', 'Bd', 'Be', 'Csnr', 'Fn1', 'M', 'Jf', 'lp', 'mp', 'nat', 'Jan',    'pe', '2020-05-01', 'us1', null, null);
INSERT INTO DEV_GREENTRAK00.PROFILES VALUES ('9dfa89d32387455ebe800ed77c200fa3', 'Bd', 'Be', 'Csnr', 'Fn2', 'M', 'Jf', 'lp', 'mp', 'nat', 'Piet',   'pe', '2020-05-01', 'us2', null, null);
INSERT INTO DEV_GREENTRAK00.PROFILES VALUES ('a7de5d729e0343419e7da348aaa8eac2', 'Bd', 'Be', 'Csnr', 'Fn3', 'M', 'Jf', 'lp', 'mp', 'nat', 'Klaas',  'pe', '2020-05-01', 'us3', null, null);
INSERT INTO DEV_GREENTRAK00.PROFILES VALUES ('caa70247ad7c4b688949edec7e879ae2', 'Bd', 'Be', 'Csnr', 'Fn4', 'M', 'Jf', 'lp', 'mp', 'nat', 'Willem', 'pe', '2020-05-01', 'us4', null, null);
...
INSERT INTO DEV_GREENTRAK00.PROFILES VALUES ('f0a3b1deee884b2885729d6afc856116', 'Bd', 'Be', 'Csnr', 'WH&FF Pvt Ltd', 'F', 'Jf', 'lp', 'mp', 'nat', 'WH&FF',  'pe', '2020-05-01', 'us6', null, null);
INSERT INTO DEV_GREENTRAK00.PROFILES VALUES ('f1a3b1deee884b2885729d6afc856116', 'Bd', 'Be', 'Csnr', 'Heijmans Infra bv', 'F', 'Jf', 'lp', 'mp', 'nat', 'Heijmans Infra',  'pe', '2020-05-01', 'us7', null, null);
...
(
    ...
    PRIMARY KEY ("CheckInDateTime", "Version", "UserID")
);
...
create view "VAttendanceEventsAll"
            ("Version", "CheckInDateTime", "FullProjOwner", "ProjectCode", "TermGuidIn", "UserID", "UserName", "FullName",
             "AggApprTime", "AggStartDate", "AggTotalTime", "ApprovalBy", "ApprovalDateTime", "CheckOutDateTime", "Description",
             "Remarks", "TermGuidOut")
as
select T1."Version",
       T1."CheckInDateTime",
...
from DEV_GREENTRAK00."AttendanceEventsAll" T1,
     ...
     (select T0."CheckInDateTime" CIDT,
             MAX(T0."Version") VERSION,
             T0."UserID" UID
      from DEV_GREENTRAK00."AttendanceEventsAll" T0
      group by T0."CheckInDateTime",
               T0."UserID") T3
...
(
    "Id"          INTEGER                  not null
        constraint P0000PROJECTS_PK primary key,
